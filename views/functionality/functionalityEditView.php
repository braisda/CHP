...
class FunctionalityEditView {
    ...
    function render(){
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            ...
            border-bottom">
                <h1 class="h2" data-translate="Editar Funcionalidad '%<?php echo $this->action->getId()?>%'"></h1>
            ...
            <form  name = "actionForm" action='../controllers/functionalityController.php?action=edit&id=<?php echo $this->action->getId()?>'
                ...
                <div id="name-div" class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                           value="<?php echo $this->action->getNombre() ?>" maxlength="60" required oninput="checkNameFunctionality(this);">
                </div>
                <div id="description-div" class="form-group">
                    <label for="description" data-translate="Descripción"></label>
                    <input type="text" class="form-control" id="description" name="description"
                           value="<?php echo $this->action->getDescripcion() ?>" maxlength="100" required oninput="checkDescriptionFunctionality(this);">
                </div>
